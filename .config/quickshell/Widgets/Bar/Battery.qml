...
Row {
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            color: (modelData.percentage < 0.2 && modelData.state !== UPowerDeviceState.Charging) 
                ? Theme.danger 
                : "transparent"
            radius: 4
            ...
            IconLabel {
                ...
                color: {
                    if (modelData.state === UPowerDeviceState.Charging) return Theme.success
                    if (modelData.percentage < 0.2) return "white"
                    return Theme.text
                }
            }
        }
