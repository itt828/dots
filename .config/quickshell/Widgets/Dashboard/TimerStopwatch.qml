            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        Text { anchors.centerIn: parent; text: modelData + "分"; color: "#37474f" }
                        MouseArea {
                            anchors.fill: parent
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            ColumnLayout {
                Layout.fillWidth: true
                spacing: 2
                Text { text: "ストップウォッチ"; color: "#263238"; font.bold: true }
                Text {
            ...
            Rectangle {
                ...
                Text { anchors.centerIn: parent; text: root.stopwatchRunning ? "停止" : "開始"; color: "#37474f" }
                MouseArea {
                    anchors.fill: parent
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
            ...
            Rectangle {
                ...
                radius: 6
                color: "#eceff1"
                Text { anchors.centerIn: parent; text: "リセット"; color: "#37474f"; font.pointSize: 9 }
                MouseArea {
                    anchors.fill: parent
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
